...
export function ProductsView() {
  ...
  const handleGenerateQR = async () => {
    ...
    try {
      ...
      setAlertData({
        type: "success",
        message: t("products.qrGeneratedSuccess"),
      });
    } catch (err) {
      const appError = handleError(err);
      setAlertData({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setAlertData({
        type: "success",
        message: t("products.productDeletedSuccess"),
      });
    ...
    try {
      ...
      if (data.type === "CITAPP_PRODUCT" && data.id) {
        ...
        if (producto) {
          ...
          setAlertData({
            type: "error",
            message: t("products.productNotFound"),
          });
        }
      }
    } catch (error) {
      ...
      <>
        ...
        <ProductDetail
          ...
          onUpdated={async () => {
            ...
            setAlertData({
              type: "success",
              message: t("products.productUpdatedSuccess"),
            });
          }}
        />
      </>
              ...
              setAlertData({
                ...
                message:
                  status === "created"
                    ...
                    : t("products.productUpdatedSuccess"),
              });
            }}
          />
        )}
