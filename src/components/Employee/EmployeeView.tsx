          ...
          <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:items-center sm:space-x-8">
              <button
                ...
                className="flex items-center space-x-2 text-gray-300 hover:text-white transition-colors group w-fit"
              >
                <ArrowLeft className="w-5 h-5 group-hover:-translate-x-1 transition-transform" />
                <span>Volver al Login</span>
              </button>

              <div className="flex items-center space-x-3 sm:border-l sm:border-gray-600 sm:pl-8">
            ...
            <button
              ...
              className="bg-white text-primary px-4 py-2 rounded-lg hover:bg-gray-100 transition-colors flex items-center justify-center space-x-2 font-semibold shadow-sm w-full sm:w-auto"
            >
